...
# Send Mail #
execute if entity @s[nbt={SelectedItem:{id:"minecraft:written_book",Count:1b}}] unless score @s SendMail matches 0..1 run function k.network:mailing/mails/sending/sending_requirements
