...
execute unless data storage k.network:database DatabaseStatus run data merge storage k.network:database {DatabaseStatus:[{Online:1b,Busy:0b}],Users:[{Id:0,Nickname:"",Mails:{Received:[{Empty:1b}],Sent:[{}]},Gifts:{Received:[{Empty:1b}]}}]}